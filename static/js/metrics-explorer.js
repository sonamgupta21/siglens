...
function validateFormula(formula, uniqueId) {
    ...
    let formulaFunctionsArray = formulaDetailsMap[uniqueId]?.functions || [];
    ...
    if (isNumeric) {
        ...
        for (let func of formulaFunctionsArray) {
    ...
    return {
        ...
        functions: formulaFunctionsArray,
        isNumeric: isNumeric,
    };
}
...
function updateTooltipForFormulaFunctions(uniqueId, validationResult) {
    ...
    console.log(validationResult.isNumeric);
